package com.inspur.common.interceptor.mybatis;
...
public class PaginationInterceptor implements Interceptor {
	...
	public String buildPageSql(String sql, Pagination<?> pagination) {
		...
		Integer beginIndex = Integer.valueOf((pagination.getPageNo() - 1) * pagination.getPageSize() + 1);
		Integer endIndex = Integer.valueOf(pagination.getPageNo() * pagination.getPageSize());
		...
		pageSql.append(") a where row_id >= ").append(beginIndex);
